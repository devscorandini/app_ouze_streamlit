...
data_minima = df1['Data Cadastro Negociação'].min()
data_maxima = df1['Data Cadastro Negociação'].max()

# Filtros de data na barra lateral
data_inicial = st.sidebar.date_input("Data Inicial", value=data_minima, min_value=data_minima)
data_final = st.sidebar.date_input("Data Final", value=data_maxima, max_value=data_maxima)
...
>>>>>>> b7785766a68d8405ef06b9b41753f74aea9ae8af
